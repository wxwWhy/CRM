...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			$(function() {
				$('#orderTable').bootstrapTable({
					url:"${pageContext.request.contextPath}/ob/selAll",
					queryParamsType : '',
					pagination: true,
		...
		//日期選擇框
			...
			//为文件导出绑定事件
			function daochu(){
				$.post("${pageContext.request.contextPath}/CRM/order/derive",
						{},
						function(data){},"json")}
	...
	<body>
		...
		<div class="container">
			<h6 id="h6">B2C销售管理-->B2C销售出库管理-->B2C销售订单列表</h6>
          ...
          <form id="queryForm">
				...
				<input type="submit"  id="dao" class="btn btn-primary" value="生成销售出库单"></button>
			</form>
			<table id="orderTable"> 
