...
var status;
  $(function(){
	  QueryAudit(num);
		...
		$("#tb").on("click",".Querybtn",function(event){
			...
			var url1="${pageContext.request.contextPath}/audit123/Querybtn?id="+id
					;
  ...
  function QueryAudit(num){
	  $.post("${pageContext.request.contextPath}/audit123/queryaudit?pageNum="+num,"",function(data){
  ...
  function Audit(id,reviewer,time,status){
	  $.post("${pageContext.request.contextPath}/audit123/admin?id="+id+"&reviewer="+reviewer+"&time="+time+"&status="+status,"",function(data){
		  QueryAudit(num);
	  })
  
  }
  function GetStatus(status){
	  $.post("${pageContext.request.contextPath}/audit123/getstatus?status="+status,"",function(data){
		  var listgifts = data.list;
