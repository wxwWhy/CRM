		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$("#tb").on("click", ".Querybtn", function(event) {
					...
					var url1 = "${pageContext.request.contextPath}/gtogmanager/Querybtn?code=" + code;
				...
				$("#tb").on("click", ".Updatebtn", function(event) {
					var code = event.currentTarget.value;
					var url2 = "${pageContext.request.contextPath}/gtogmanager/Querybtn?code=" + code;
				...
				$("#addbtn").on("click", function() {
					location.href = "${pageContext.request.contextPath}/gtogmanager/querygoods";
				})
				$("#tb").on("click", ".SHGZbtn", function(event) {
					var id = event.currentTarget.value;
					var url2 = "${pageContext.request.contextPath}/gtogmanager/SHGZbtn?id=" + id;
					$.get(url2, function(data) {
						var abc = eval(data);
			...
			function queryGoods(num) {
				$.post("${pageContext.request.contextPath}/gtogmanager/all2?pageNum=" + num, "", function(data) {
			...
			function UpdateGifts(id, addgifts, newprice) {
				$.post("${pageContext.request.contextPath}/gtogmanager/update?id=" + id + "&addgifts=" + addgifts + "&newprice=" + newprice, "", function(data) {
					queryGoods(num);
				}, "text");
			...
			function delGifts(id) {
				$.post("${pageContext.request.contextPath}/gtogmanager/delete?id=" + id, "", function(data) {
					queryGoods(num);
				}, "text");
			}

			function SsGoods(gname, type, status) {
				$.post("${pageContext.request.contextPath}/gtogmanager/ssgoods?gname=" + gname + "&type=" + type + "&status=" + status, "", function(data) {
					var listgifts = data.list;
				...
				<div class="container">
					<div class="row" style="background-color: white;">
						...
						<div id="box">
							...
							<input id="addbtn" type="button" class="btn btn-fault" data-toggle="modal" data-target="#myModel1" style="background-color: #0080FF" value="新增商品转赠品">
							</br>
